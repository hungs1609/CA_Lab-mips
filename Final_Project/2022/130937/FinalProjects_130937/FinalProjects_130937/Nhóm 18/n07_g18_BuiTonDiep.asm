...
#ma opcode hop le:
opcode: .asciiz "lw-lb-sw-sb-addi-add-addiu-addu-and-andi-beq-bne-div-divu-j-jal-lui-mfhi-mflo-mul-nop-nor-orori-sll-slt-slti-sub-subu-syscall-xor-xori-"
...
tmp3: .space 20 # thanh phan cat duoc ơ offset(base)
.text
main:
Input: # lay dau vao
	li $v0, 4
...
# tra ve chuoi opcode tuong ung ơ tmp2 =
#--------------------------------------------------------
getOperand:
	addi $sp, $sp, -20
	sw $s0, 16($sp) #i
